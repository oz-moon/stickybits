...
Stickybit.prototype.manageStickiness = function manageStickiness() {
  ...
  this.manageState = () => {
    ...
    if ((scroll > stickyStart) && (scroll < stickyStop) && state === 'default') state = 'sticky';
    else if ((scroll < stickyStart) && state === 'sticky') state = 'default';
    else if ((scroll < stickyStop) && state === 'stuck') state = 'sticky';
    else if ((scroll > stickyStop) && state === 'sticky') state = 'stuck';
    else return;
